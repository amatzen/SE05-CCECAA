...
By using Infrastructure as Code, the way of architecting and implementing a cloud solution is done in a declarative way. The main advantage for the declarative way is to have version control for the cloud setup and portability between cloud accounts.
